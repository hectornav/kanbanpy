...
const T = {
  es: {
    ...
    "org.create": "Crear organización", "org.join": "Unirme con código",
    "org.name": "Nombre de la organización", "org.namePh": "Ej. Familia García",
    "org.inviteCode": "Código de invitación", "org.inviteCodePh": "Pídeselo a quien te invitó",
    "org.createHint": "Serás el administrador de esta organización.",
    "org.joinHint": "Únete al espacio de trabajo de tu organización.",
    "nav.admin": "Admin",
    "admin.title": "Administrar organización",
    "admin.inviteHint": "Comparte este código para que alguien se una a tu organización al registrarse.",
    "admin.copy": "Copiar", "admin.copied": "Copiado", "admin.copyFail": "No se pudo copiar el código.",
    "admin.rotate": "Regenerar", "admin.confirmRotate": "¿Regenerar el código? El anterior dejará de funcionar.",
    "admin.rotated": "Código regenerado.", "admin.renamed": "Nombre actualizado.",
    "admin.members": "Miembros", "admin.membersHint": "Desactiva una cuenta para bloquear el acceso sin borrarla.",
    "admin.badgeAdmin": "admin", "admin.badgeInactive": "inactivo",
    "admin.activate": "Activar", "admin.deactivate": "Desactivar",
    "admin.cannotSelf": "No puedes desactivar tu propia cuenta.",
    ...
    "col.Backlog": "Backlog", "col.ToDo": "Por hacer", "col.Doing": "En curso", "col.Done": "Hecho",
    "board.addInline": "+ Añadir", "board.closeBanner": "toca para cerrar", "board.moveTo": "Mover a",
    ...
    "ai.openaiOpt": "OpenAI y compatibles", "ai.baseUrl": "URL base de la API",
    ...
    "ai.configure": "⚙︎ Configurar", "ai.noEdit": "Solo el administrador de la organización puede configurar la IA.",
  ...
  ca: {
    ...
    "org.create": "Crear organització", "org.join": "Unir-me amb codi",
    "org.name": "Nom de l'organització", "org.namePh": "Ex. Família García",
    "org.inviteCode": "Codi d'invitació", "org.inviteCodePh": "Demana'l a qui et va convidar",
    "org.createHint": "Seràs l'administrador d'aquesta organització.",
    "org.joinHint": "Uneix-te a l'espai de treball de la teva organització.",
    "nav.admin": "Admin",
    "admin.title": "Administra l'organització",
    "admin.inviteHint": "Comparteix aquest codi perquè algú s'uneixi a la teva organització en registrar-se.",
    "admin.copy": "Copia", "admin.copied": "Copiat", "admin.copyFail": "No s'ha pogut copiar el codi.",
    "admin.rotate": "Regenera", "admin.confirmRotate": "Vols regenerar el codi? L'anterior deixarà de funcionar.",
    "admin.rotated": "Codi regenerat.", "admin.renamed": "Nom actualitzat.",
    "admin.members": "Membres", "admin.membersHint": "Desactiva un compte per bloquejar-ne l'accés sense esborrar-lo.",
    "admin.badgeAdmin": "admin", "admin.badgeInactive": "inactiu",
    "admin.activate": "Activa", "admin.deactivate": "Desactiva",
    "admin.cannotSelf": "No pots desactivar el teu propi compte.",
    ...
    "col.Backlog": "Backlog", "col.ToDo": "Per fer", "col.Doing": "En curs", "col.Done": "Fet",
    "board.addInline": "+ Afegeix", "board.closeBanner": "toca per tancar", "board.moveTo": "Mou a",
    ...
    "ai.openaiOpt": "OpenAI i compatibles", "ai.baseUrl": "URL base de l'API",
    ...
    "ai.configure": "⚙︎ Configura", "ai.noEdit": "Només l'administrador de l'organització pot configurar la IA.",
  ...
  en: {
    ...
    "org.create": "Create organization", "org.join": "Join with a code",
    "org.name": "Organization name", "org.namePh": "e.g. The Garcia Family",
    "org.inviteCode": "Invite code", "org.inviteCodePh": "Ask whoever invited you",
    "org.createHint": "You'll be this organization's admin.",
    "org.joinHint": "Join your organization's shared workspace.",
    "nav.admin": "Admin",
    "admin.title": "Manage organization",
    "admin.inviteHint": "Share this code so someone can join your organization when they sign up.",
    "admin.copy": "Copy", "admin.copied": "Copied", "admin.copyFail": "Could not copy the code.",
    "admin.rotate": "Regenerate", "admin.confirmRotate": "Regenerate the code? The old one will stop working.",
    "admin.rotated": "Code regenerated.", "admin.renamed": "Name updated.",
    "admin.members": "Members", "admin.membersHint": "Deactivate an account to block access without deleting it.",
    "admin.badgeAdmin": "admin", "admin.badgeInactive": "inactive",
    "admin.activate": "Activate", "admin.deactivate": "Deactivate",
    "admin.cannotSelf": "You cannot deactivate your own account.",
    ...
    "col.Backlog": "Backlog", "col.ToDo": "To do", "col.Doing": "In progress", "col.Done": "Done",
    "board.addInline": "+ Add", "board.closeBanner": "tap to close", "board.moveTo": "Move to",
    ...
    "ai.openaiOpt": "OpenAI & compatible", "ai.baseUrl": "API base URL",
    "ai.apiKey": "API key", "ai.apiKeyPh": "sk-ant-…  (empty = keep current)", "ai.keySet": "Key set ✓",
    "ai.model": "Model", "ai.serverUrl": "Model server URL",
    "ai.configure": "⚙︎ Configure", "ai.noEdit": "Only the organization admin can configure AI.",
